...
@section('title','E-Panrita Mart || Kontak')
						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									@endphp
									<h4>Get in touch</h4>
									<h3>Kirimkan Pesan @auth @else<span style="font-size:12px;" class="text-danger">[You need to login first]</span>@endauth</h3>
								</div>
									...
									<div class="row">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="subject" type="text" id="subject" placeholder="Masukkan Subject">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
